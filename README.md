...
## About this repo
We try to solve given problem statement using built in data structures, we try to implement user defined datastructures 
and various approaches towards solving a problem.
